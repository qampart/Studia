...
//compilation fs
	    ...
	    function draw()
			...
			*/		
			...
			let distance = glm.length(cameraPos);
			console.log(distance);
				...
				if(distance < 32) {
				console.log(1);
				gl.drawArrays(gl.TRIANGLES, 0, 105864);
				}
				else if(distance < 34){
				console.log(2);
				gl.drawArrays(gl.TRIANGLES, 105864, 52932);
				}
				else if(distance < 36){
				console.log(3);
				gl.drawArrays(gl.TRIANGLES, 158796, 10584);
				}
				else if(distance > 36){
				console.log(4);
				gl.drawArrays(gl.TRIANGLES, 169380, 528);
				}
